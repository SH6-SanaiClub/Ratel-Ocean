...
<jsp:include page="/WEB-INF/views/common/headerBase.jsp" />
    <div class="container">
        <div class="page-header" style="background: var(--primary-color); color: #fff; border-radius: 12px; padding: 16px 0 16px 24px; margin-bottom: 24px; display: flex; align-items: center; min-height: 50px;">
            <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <div>
                    ...
                    <p style="font-size: 0.875rem; color: #eaf7fa; font-weight: 400; margin: 0;">제안한 계약서를 확인하고 관리하세요</p>
                </div>
            </div>
        </div>
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:when test="${m.status != null and (m.status.name() eq 'DEPOSITED' or m.status.name() eq 'deposited')}">
                                                        <div class="milestone-status-message">
                                                            <span class="status-info">💼 프리랜서가 작업을 진행합니다...</span>
                                                        </div>
                                                    </c:when>
                                                    <c:when test="${m.status != null and (m.status.name() eq 'PAID' or m.status.name() eq 'paid')}">
                                                        <div class="milestone-status-message">
