...
<head>
    ...
    <title>프리랜서 리뷰 작성 | Ratel Ocean</title>
    
    <!--
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
     클라이언트 → 프리랜서 리뷰 작성 페이지
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    
    [목적]
    계약 완료 후 클라이언트가 프리랜서에 대한 평가를 작성합니다.
    ...
    <style>
        ...
        * {
        ...
        .renewal-option input[type="radio"]:checked + label {
            background: #1F7A8C;
            color: #FFFFFF;
            border-color: #1F7A8C;
        }
        
        .renewal-option label:hover {
            border-color: #9AD9DB;
            background: #E0F2F4;
        }
...
<jsp:include page="/WEB-INF/views/common/header.jsp" />
    <div class="container">
        ...
        <div class="header">
            <h1>🌟 프리랜서 리뷰 작성</h1>
            <p>프로젝트가 완료되었습니다. 프리랜서에 대한 평가를 남겨주세요.</p>
        </div>
        ...
        <!-- ━━━━ 리뷰 작성 폼 ━━━━ -->
        <form id="reviewForm" action="${pageContext.request.contextPath}/review/client" method="POST" onsubmit="return validateForm()">
            <!-- Hidden 필드 -->
            ...
            <div class="form-group">
                <label>
                    재계약 의사 <span class="required">*</span>
                </label>
                <div class="renewal-options">
                    <div class="renewal-option">
                        <input type="radio" id="renewalYes" name="isRenewalIntended" value="true" required>
                        <label for="renewalYes">✅ 재계약 원함</label>
                    </div>
                    <div class="renewal-option">
                        <input type="radio" id="renewalNo" name="isRenewalIntended" value="false" required>
                        <label for="renewalNo">❌ 재계약 원하지 않음</label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea 
                    ...
                    name="experience" 
                    placeholder="프리랜서의 강점, 협업 경험, 작업 품질 등을 자유롭게 작성해주세요. 이 리뷰는 공개됩니다."
    ...
    <script>
        ...
        function validateForm() {
            ...
            const renewalIntended = document.querySelector('input[name="isRenewalIntended"]:checked');
            ...
            const confirmed = confirm(
                '별점: ' + rating + '점\n' +
                '재계약 의사: ' + (renewalIntended.value === 'true' ? '원함' : '원하지 않음') + '\n\n' +
                '위 내용으로 리뷰를 제출하시겠습니까?'
            );
