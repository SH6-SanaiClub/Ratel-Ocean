    ...
    <div class="container">
        ...
        <div class="main-layout layout-3col">
            ...
            <div class="sidebar sidebar-slim">
                ...
                <%-- 상태 지표 계산 --%>
                <c:set var="totalRequested" value="0"/><!-- 작업 가능 마일스톤 수 -->
                <c:set var="totalInProgress" value="0"/><!-- SIGNED + PAID + WAITING -->
                <c:set var="totalPaymentRequest" value="0"/><!-- 지급 요청 금액/건수 (필요 시 확장) -->
                ...
                <div class="sidebar-stats">
                    <div class="sidebar-stat-item">
                        ...
                        <span class="sidebar-stat-label">작업 가능</span>
                        </div>
                    <div class="sidebar-stat-item">
                        ...
                        <div class="kpi-grid">
                            ...
                            <div class="kpi-card kpi-wide">
                                <div style="display:flex; flex-direction:column; gap:6px;">
                                    ...
                                    <div class="kpi-money">&#8361; <fmt:formatNumber value="${kpiDepositedAmount}" pattern="#,###"/></div>
                                </div>
                        ...
                        <c:if test="${not empty milestones}">
                            ...
                            <div class="milestone-list milestone-timeline">
                                <c:forEach var="m" items="${milestones}" varStatus="status">
                                    <div class="milestone-card milestone-${fn:toLowerCase(m.status.name())} ${m.status != null and (m.status.name() eq 'DEPOSITED' or m.status.name() eq 'deposited') ? 'is-current' : ''}">
