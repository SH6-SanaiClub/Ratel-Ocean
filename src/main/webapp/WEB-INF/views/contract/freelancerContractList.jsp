...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .reject-form { display: flex; gap: 12px; align-items: flex-end; }
        .reject-form input { flex: 1; padding: 12px; border: 1px solid #ced4da; border-radius: 8px; font-size: 14px; }
    </style>
</head>
<body>
<div class="container">
                ...
                <div class="status-section">
                    <div class="status-title">
                        ...
                        <c:choose>
                            ...
                            <%-- [수정 2] statusEntry.key.name().toLowerCase() 로 변경 --%>
        ...
        <div class="content-area">
            <c:choose>
                <c:when test="${not empty selectedContract}">
                    ...
                    <%-- [수정 5] .name() 추가 및 소문자 비교 삭제 --%>
                    <c:if test="${selectedContract.contractStatus.name() eq 'WAITING'}">
