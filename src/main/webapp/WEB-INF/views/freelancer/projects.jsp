...
<div class="dashboard-wrap">
    ...
    <!-- 🔍 검색 -->
    <form class="search-box" method="get" action="${pageContext.request.contextPath}/freelancer/projects">
        <input type="text"
               name="keyword"
    ...
    <div class="project-list">
        ...
        <c:if test="${empty projectList}">
            <div class="empty">조건에 맞는 프로젝트가 없습니다. 나중에 다시 확인해주세요!</div>
        </c:if>
        ...
        <div class="pagination">
            ...
            <c:choose>
                <c:when test="${hasPrevBlock}">
                    <a class="page-link"
                       href="${pageContext.request.contextPath}/freelancer/projects?page=${prevBlockPage}&size=${size}&onlyActive=${onlyActive}&keyword=${fn:escapeXml(keyword)}">&laquo;</a>
                </c:when>
                <c:otherwise>
            ...
            <c:choose>
                <c:when test="${page > 1}">
                    <a class="page-link"
                       href="${pageContext.request.contextPath}/freelancer/projects?page=${page-1}&size=${size}&onlyActive=${onlyActive}&keyword=${fn:escapeXml(keyword)}">&lsaquo;</a>
                </c:when>
                <c:otherwise>
            ...
            <c:forEach var="pno" begin="${startPage}" end="${endPage}">
                <a class="page-link ${pno == page ? 'active' : ''}"
                   href="${pageContext.request.contextPath}/freelancer/projects?page=${pno}&size=${size}&onlyActive=${onlyActive}&keyword=${fn:escapeXml(keyword)}">${pno}</a>
            </c:forEach>
            ...
            <c:choose>
                <c:when test="${page < totalPages}">
                    <a class="page-link"
                       href="${pageContext.request.contextPath}/freelancer/projects?page=${page+1}&size=${size}&onlyActive=${onlyActive}&keyword=${fn:escapeXml(keyword)}">&rsaquo;</a>
                </c:when>
                <c:otherwise>
            ...
            <c:choose>
                <c:when test="${hasNextBlock}">
                    <a class="page-link"
                       href="${pageContext.request.contextPath}/freelancer/projects?page=${nextBlockPage}&size=${size}&onlyActive=${onlyActive}&keyword=${fn:escapeXml(keyword)}">&raquo;</a>
                </c:when>
                <c:otherwise>
