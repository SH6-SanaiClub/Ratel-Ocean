...
/* ================================================
   중앙 영역 - Queue 로고 + 네비게이션
================================================ */
.header-center { flex: 1; display: flex; align-items: center; justify-content: center; gap: 3rem; }
.header-center .queue-logo { display: block; line-height: 0; }
.header-center .queue-logo img { height: 38px; object-fit: contain; }
...
<header class="site-header">
  <div class="header-inner">
    ...
    <div class="header-left">
      <a class="brand-logo" href="${pageContext.request.contextPath}/freelancer/main">
    ...
    <div class="header-center">
      <a class="queue-logo" href="${pageContext.request.contextPath}/queue">
        <img src="${pageContext.request.contextPath}/resources/images/queuelogo.png" alt="Queue">
      </a>
      <nav>
        <a href="${pageContext.request.contextPath}/freelancer/projects">프로젝트 찾기</a>
        <a href="${pageContext.request.contextPath}/freelancer/my-projects">내 프로젝트 관리</a>
        <a href="${pageContext.request.contextPath}/freelancer/finance">내 금융 관리</a>
        <a href="${pageContext.request.contextPath}/freelancer/career">내 경력 관리</a>
      </nav>
    </div>
    ...
    <div class="header-right">
      ...
      <a class="icon-btn" href="${pageContext.request.contextPath}/chat" aria-label="채팅">
        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/><path d="M7 9h10v2H7zm0 4h7v2H7z"/></svg>
        <span class="badge"></span>
      </a>
      <div class="profile-dropdown">
        ...
        <div class="profile-menu">
          <a href="${pageContext.request.contextPath}/freelancer/main">마이 프로필</a>
